  ...
  missions: [
    {
      ...
      conversationRefs: [
        {
          id: "starter-conversation-honey",
          channelId: "starter-channel",
          rootEventId: "starter-thread-honey",
          label: "Honey",
          agentIds: [HONEY_PUBKEY],
          linkedAt: STARTER_TIME,
          dispatchId: "starter-dispatch-honey",
        },
        {
          id: "starter-conversation-fizz",
          channelId: "starter-channel",
          rootEventId: "starter-thread-fizz",
          label: "Fizz",
          agentIds: [FIZZ_PUBKEY],
          linkedAt: STARTER_TIME,
          dispatchId: "starter-dispatch-fizz",
        },
      ],
...
export function cloneCockpitState(state: CockpitState): CockpitState {
  return {
    ...
    missions: state.missions.map((mission) => ({
      ...
      conversationRefs: mission.conversationRefs?.map((conversation) => ({
        ...conversation,
